...
## Failing checks in the GitHub Action

When you push code to GitHub, the `check_project` GitHub Action runs
[`check_project()`](https://inbo.github.io/checklist/reference/check_project.md)
on your project. If any of the checks fail, you will see a red cross in
the “Actions” tab of your repository on GitHub. Click on the “Actions”
tab and then on the failed workflow to see which check(s) failed and
what the error message is. You can then fix the issues locally and push
the changes to GitHub to run the checks again. Pro tip: you can also run
[`check_project()`](https://inbo.github.io/checklist/reference/check_project.md)
locally to see which checks fail before pushing to GitHub.

The GitHub Action might fail because of other issues, like problems with
installing dependencies. Please have a look at this
[section](https://inbo.github.io/checklist/articles/getting_started.html#failing-check-package-on-github-actions)
in the
[`vignette("getting_started", package = "checklist")`](https://inbo.github.io/checklist/articles/getting_started.md)
