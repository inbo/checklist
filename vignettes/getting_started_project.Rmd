...
- Copy the code listed in your newly created repository on GitHub under "...or push an existing repository from the command line" and run it in the command line.
