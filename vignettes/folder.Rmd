...
We advise to use sub folders with `source`, `data` and / or `media` when the project is more complex.
You are free create a relevant folder structure with these folders.
