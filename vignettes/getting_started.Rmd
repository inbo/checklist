...
Were do you want to set-up `checklist`?
...
1. Use `x$update_keywords()` if you want to define a set of keywords.
  These keywords occur in `INST/citation`, `CITATION.cff` and `.zenodo.json`.
  The functions add the keyword "R package" automatically to the citation files.
