...
Then it askes which warnings and notes you want to allow.
...
Upon success, the function returns a string starting with `Bearer` followe by an alphanumeric UUID, e.g. dc0a6b6b-b4d4-4276-bc89-78c1e9ede56e.
