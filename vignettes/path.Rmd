...
The use that information to define the absolute location of the files within the project.
...
The maintainer should document this structure and give the user instruction on how to set up a project.
...
Beside writing good documentation, you should check the content of the system variable.
Your code should provide helpful errors when the user failed to set the correct system variable.
