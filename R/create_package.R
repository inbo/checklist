...
",
  ...
  tidy_desc(path)
  gert::git_add("DESCRIPTION", repo = repo)
  ...
  gert::git_add("NAMESPACE", repo = repo)
  ...
  gert::git_add(paste0(package, ".Rproj"), repo = repo)
  ...
  gert::git_add(".Rbuildignore", repo = repo)
  ...
  gert::git_add("codecov.yml", repo = repo)
  ...
  gert::git_add("NEWS.md", repo = repo)
  ...
  gert::git_add("README.Rmd", repo = repo)
  ...
  gert::git_add("LICENSE.md", repo = repo)
...
allowed:
  ...
  gert::git_add("checklist.yml", repo = repo)
  ...
  gert::git_add(file.path(".github", "CODE_OF_CONDUCT.md"), repo = repo)
  ...
  gert::git_add(file.path(".github", "CONTRIBUTING.md"), repo = repo)
  ...
  gert::git_add("_pkgdown.yml", repo = repo)
  ...
  gert::git_add(file.path("pkgdown", "extra.css"), repo = repo)
  ...
  gert::git_add(file.path("man", "figures", "logo-en.png"),
                force = TRUE, repo = repo)
  file.copy(
    system.file(
