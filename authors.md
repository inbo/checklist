...
Onkelinx, Thierry (2025) checklist: A Thorough and Strict Set of Checks
for R Packages and Source Code. Version 0.5.0.
https://inbo.github.io/checklist/

    @Manual{,
      title = {checklist: A Thorough and Strict Set of Checks for R Packages and Source Code. Version 0.5.0},
